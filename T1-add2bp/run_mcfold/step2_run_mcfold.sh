...
cat 5bp267_add2bp_all_possible_diff_barcode.txt | while read line
...
echo "./mcfold.static.exe >seq${count}_5bp_267_add2bp_all_possible.data" >>seq${count}_run_mcfold.sh
